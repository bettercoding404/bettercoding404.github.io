...
## 参考资料
 - [PyJose 官方文档](https://python-jose.readthedocs.io/en/latest/){: rel="nofollow"}
 - [python-jose-cryptodome 官方文档](https://github.com/mpdavis/python-jose-cryptodome){: rel="nofollow"}
 - [JSON Web Tokens 官方文档](https://jwt.io/introduction){: rel="nofollow"}