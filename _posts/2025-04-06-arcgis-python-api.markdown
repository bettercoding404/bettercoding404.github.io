...
## 参考资料
- [ArcGIS Python API 官方文档](https://developers.arcgis.com/python/){: rel="nofollow"}
- [ArcGIS Python API 教程](https://www.esri.com/arcgis-blog/products/product/geoprocessing/using-arcgis-python-api/){: rel="nofollow"}