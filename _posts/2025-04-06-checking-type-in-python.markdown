...
## 参考资料
- [Python 官方文档 - 类型检查](https://docs.python.org/3/library/typing.html){: rel="nofollow"}
- [Python 官方文档 - isinstance() 函数](https://docs.python.org/3/library/functions.html#isinstance){: rel="nofollow"}
- [Python 官方文档 - type() 函数](https://docs.python.org/3/library/functions.html#type){: rel="nofollow"}
