...
## 参考资料
- [Discord.py官方文档](https://discordpy.readthedocs.io/en/stable/){: rel="nofollow"}
- [Discord开发者文档 - 斜杠命令](https://discord.com/developers/docs/interactions/application-commands#slash-commands){: rel="nofollow"}