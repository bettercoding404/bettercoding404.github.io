...
## 参考资料
- [Python官方文档 - 算术运算](https://docs.python.org/3/reference/expressions.html#binary-arithmetic-operations){: rel="nofollow"}
- [Python教程 - 除法运算](https://www.runoob.com/python3/python3-basic-operators.html){: rel="nofollow"}