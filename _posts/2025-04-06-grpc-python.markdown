...
## 参考资料
- [gRPC 官方文档](https://grpc.io/docs/){: rel="nofollow"}
- [gRPC Python 官方文档](https://grpc.io/docs/languages/python/){: rel="nofollow"}
- [Protocol Buffers 官方文档](https://developers.google.com/protocol-buffers/docs/overview){: rel="nofollow"}