...
- [Python官方文档 - virtualenv](https://virtualenv.pypa.io/en/latest/){: rel="nofollow"}
- [PyCharm官方文档 - 管理项目解释器](https://www.jetbrains.com/help/pycharm/configuring-python-interpreter.html){: rel="nofollow"}
- [Visual Studio Code官方文档 - Python 环境管理](https://code.visualstudio.com/docs/python/environments){: rel="nofollow"}