...
## 参考资料
- [Python官方文档 - 循环](https://docs.python.org/3/tutorial/controlflow.html#for-statements){: rel="nofollow"}
- [Python官方文档 - 迭代器](https://docs.python.org/3/library/stdtypes.html#typeiter){: rel="nofollow"}