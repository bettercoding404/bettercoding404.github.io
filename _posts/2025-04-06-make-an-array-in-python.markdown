...
## 参考资料
- [Python官方文档 - list](https://docs.python.org/3/library/stdtypes.html#list){: rel="nofollow"}
- [Python官方文档 - array](https://docs.python.org/3/library/array.html){: rel="nofollow"}
