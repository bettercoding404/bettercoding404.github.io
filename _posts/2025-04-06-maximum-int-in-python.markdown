...
## 参考资料
- [Python 官方文档 - 整数类型](https://docs.python.org/3/library/stdtypes.html#numeric-types-int-float-complex){: rel="nofollow"}
- [gmpy2 官方文档](https://gmpy2.readthedocs.io/en/latest/){: rel="nofollow"}