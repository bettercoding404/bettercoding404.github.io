...
## 参考资料
- [Python官方文档 - 作用域和命名空间](https://docs.python.org/3/tutorial/classes.html#python - scope - and - namespaces){: rel="nofollow"}
- [Real Python - Python's nonlocal Keyword](https://realpython.com/python - nonlocal - keyword/){: rel="nofollow"}