...
- [Python Testing with pytest](https://pragprog.com/book/bopytest/python-testing-with-pytest){: rel="nofollow"}
- [pytest 教程](https://www.learnenough.com/pytest-tutorial/basics){: rel="nofollow"}