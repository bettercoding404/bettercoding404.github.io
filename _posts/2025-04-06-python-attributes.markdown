...
## 参考资料
- [Python官方文档 - Classes](https://docs.python.org/3/tutorial/classes.html){: rel="nofollow"}
- [Python Data Model](https://docs.python.org/3/reference/datamodel.html){: rel="nofollow"}