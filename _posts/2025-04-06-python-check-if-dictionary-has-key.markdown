...
- [Python 官方文档 - 内置函数 - in](https://docs.python.org/3/reference/expressions.html#in){: rel="nofollow"}
- [Python 官方文档 - 字典方法 - get()](https://docs.python.org/3/library/stdtypes.html#dict.get){: rel="nofollow"}
- [Python 官方文档 - 字典方法 - keys()](https://docs.python.org/3/library/stdtypes.html#dict.keys){: rel="nofollow"}