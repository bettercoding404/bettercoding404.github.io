...
## 参考资料
- [Python 官方文档 - 内置函数 - type()](https://docs.python.org/3/library/functions.html#type){: rel="nofollow"}
- [Python 官方文档 - 内置函数 - isinstance()](https://docs.python.org/3/library/functions.html#isinstance){: rel="nofollow"}
- [Python 官方文档 - 数据结构 - 字典](https://docs.python.org/3/tutorial/datastructures.html#dictionaries){: rel="nofollow"}