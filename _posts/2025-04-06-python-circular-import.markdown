...
- [Flask 官方文档 - 应用工厂](https://flask.palletsprojects.com/en/2.2.x/patterns/appfactories/){: rel="nofollow"}
- [Django 官方文档 - 模型关系](https://docs.djangoproject.com/en/4.1/topics/db/models/){: rel="nofollow"}