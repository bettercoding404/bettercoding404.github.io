...
2. [Python Debugger 扩展官方文档](https://github.com/microsoft/debugpy){: rel="nofollow"}
3. [VS Code 扩展更新机制文档](https://code.visualstudio.com/docs/editor/extension-marketplace#_updating-extensions){: rel="nofollow"}