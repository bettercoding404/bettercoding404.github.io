...
## 参考资料
- [Python官方文档 - 字符串和字节序列](https://docs.python.org/3/library/stdtypes.html#text-sequence-type-str){: rel="nofollow"}
- [Python官方文档 - 编码和 Unicode](https://docs.python.org/3/howto/unicode.html){: rel="nofollow"}
- [维基百科 - 字符编码](https://zh.wikipedia.org/wiki/%E5%AD%97%E7%AC%A6%E7%BC%96%E7%A0%81){: rel="nofollow"}