...
## 参考资料
- [Python官方文档 - ssl模块](https://docs.python.org/3/library/ssl.html){: rel="nofollow"}
- [RFC 5246 - The Transport Layer Security (TLS) Protocol Version 1.2](https://tools.ietf.org/html/rfc5246){: rel="nofollow"}
- [Let's Encrypt官方网站](https://letsencrypt.org/){: rel="nofollow"}