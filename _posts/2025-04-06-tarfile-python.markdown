...
## 参考资料
- [Python 官方文档 - tarfile 模块](https://docs.python.org/3/library/tarfile.html){: rel="nofollow"}
- [Python 教程 - 文件处理与压缩](https://www.python-course.eu/compression.php){: rel="nofollow"}