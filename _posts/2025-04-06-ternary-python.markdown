...
## 参考资料
- [Python官方文档 - 表达式](https://docs.python.org/3/reference/expressions.html){: rel="nofollow"}
- [Python教程 - 三元表达式](https://www.runoob.com/python3/python3-ternary-operator.html){: rel="nofollow"}