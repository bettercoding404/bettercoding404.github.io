...
## 参考资料
- [Google Cloud BigQuery Python Client Library Documentation](https://googleapis.dev/python/bigquery/latest/){: rel="nofollow"}
- [Google Cloud Authentication Documentation](https://cloud.google.com/docs/authentication){: rel="nofollow"}
