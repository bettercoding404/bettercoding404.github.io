...
## 参考资料
- [Python官方文档 - 数据模型](https://docs.python.org/3/reference/datamodel.html#object.__hash__){: rel="nofollow"}
- [Python教程 - 字典](https://www.python.org/doc/essays/dictionary/){: rel="nofollow"}
