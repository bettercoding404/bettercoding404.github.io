...
## 参考资料
- [Python官方文档 - eval函数](https://docs.python.org/3/library/functions.html#eval){: rel="nofollow"}
- [Python官方文档 - ast.literal_eval函数](https://docs.python.org/3/library/ast.html#ast.literal_eval){: rel="nofollow"}