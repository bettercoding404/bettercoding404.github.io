...
## 参考资料
- [Python官方文档 - list.index()](https://docs.python.org/3/tutorial/datastructures.html#more-on-lists){: rel="nofollow"}
- [Python官方文档 - str.index()](https://docs.python.org/3/library/stdtypes.html#str.index){: rel="nofollow"}