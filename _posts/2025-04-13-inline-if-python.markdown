...
## 参考资料
- [Python官方文档 - 表达式和语句](https://docs.python.org/3/reference/expressions.html){: rel="nofollow"}
- [Python教程 - 内联条件语句](https://www.tutorialspoint.com/python3/python3_if_else.htm){: rel="nofollow"}