...
## 参考资料
- [PracticePython.org](https://www.practicepython.org/){: rel="nofollow"}
- [Python 官方文档](https://docs.python.org/3/){: rel="nofollow"}
- [PEP 8 - Style Guide for Python Code](https://www.python.org/dev/peps/pep-0008/){: rel="nofollow"}
- [unittest - Unit testing framework](https://docs.python.org/3/library/unittest.html){: rel="nofollow"}
- [pytest Documentation](https://docs.pytest.org/en/stable/){: rel="nofollow"}
- [git - The simple guide](https://www.git-tower.com/learn/git/ebook/cn/){: rel="nofollow"}