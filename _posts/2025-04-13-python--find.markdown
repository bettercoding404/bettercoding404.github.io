...
- [Python 字符串查找方法的性能优化](https://www.techwithtim.net/tutorials/game-development-with-python/string-search-optimization/){: rel="nofollow"}
- [Python 正则表达式教程](https://www.runoob.com/python3/python3-reg-expressions.html){: rel="nofollow"}