...
- [A Guide to Python's Abstract Syntax Trees](https://eli.thegreenplace.net/2010/01/28/generating-python-source-code-with-an-ast/){: rel="nofollow"}
- [Using Python's AST for Rewriting and Analyzing Python Code](https://www.blog.pythonlibrary.org/2019/04/10/using-pythons-ast-for-rewriting-and-analyzing-python-code/){: rel="nofollow"}