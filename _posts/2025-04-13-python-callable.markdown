...
## 参考资料
- [Python 官方文档 - 可调用对象](https://docs.python.org/3/reference/datamodel.html#callable-objects){: rel="nofollow"}
- [Python 教程 - 函数作为一等公民](https://www.python-course.eu/python3_function_closures.php){: rel="nofollow"}
- 《Python 核心编程》（第 3 版）