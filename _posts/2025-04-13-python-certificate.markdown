...
## 参考资料
1. [Python官方文档 - ssl模块](https://docs.python.org/3/library/ssl.html){: rel="nofollow"}
2. [certifi库官方文档](https://certifi.readthedocs.io/en/latest/){: rel="nofollow"}
3. [Requests库官方文档](https://requests.readthedocs.io/en/latest/){: rel="nofollow"}