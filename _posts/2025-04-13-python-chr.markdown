...
## 参考资料
- [Python官方文档 - chr函数](https://docs.python.org/3/library/functions.html#chr){: rel="nofollow"}
- [Python Unicode 教程](https://www.runoob.com/python3/python3-unicode.html){: rel="nofollow"}