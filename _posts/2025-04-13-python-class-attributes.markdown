...
## 参考资料
- [Python 官方文档 - Classes](https://docs.python.org/3/tutorial/classes.html){: rel="nofollow"}
- [Python 类和实例属性](https://www.tutorialspoint.com/python3/python3_classes_objects.htm){: rel="nofollow"}