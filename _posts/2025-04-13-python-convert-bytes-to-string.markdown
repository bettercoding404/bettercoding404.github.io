...
## 参考资料
- [Python 官方文档 - bytes 对象](https://docs.python.org/3/library/stdtypes.html#bytes){: rel="nofollow"}
- [Python 官方文档 - str 对象](https://docs.python.org/3/library/stdtypes.html#str){: rel="nofollow"}
- [Python 官方文档 - 编码与解码](https://docs.python.org/3/howto/unicode.html){: rel="nofollow"}