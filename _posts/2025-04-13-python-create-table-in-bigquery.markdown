...
## 参考资料
- [Google BigQuery官方文档](https://cloud.google.com/bigquery/docs){: rel="nofollow"}
- [google-cloud-bigquery库文档](https://googleapis.dev/python/bigquery/latest/index.html){: rel="nofollow"}