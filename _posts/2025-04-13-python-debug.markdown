...
## 参考资料
- [Python 官方文档 - Debugging](https://docs.python.org/3/library/pdb.html){: rel="nofollow"}
- [PyCharm 官方文档 - Debugging](https://www.jetbrains.com/help/pycharm/debugging-your-first-python-script.html){: rel="nofollow"}
