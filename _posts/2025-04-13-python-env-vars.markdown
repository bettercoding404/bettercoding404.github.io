...
## 参考资料
- [Python官方文档 - os.environ](https://docs.python.org/3/library/os.html#os.environ){: rel="nofollow"}
- [The Twelve-Factor App - Config](https://12factor.net/config){: rel="nofollow"}
