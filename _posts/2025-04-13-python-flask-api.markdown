...
## 参考资料
1. [Flask 官方文档](https://flask.palletsprojects.com/){: rel="nofollow"}
2. [Flask-HTTPAuth 文档](https://flask-httpauth.readthedocs.io/){: rel="nofollow"}
3. [Flask-SQLAlchemy 文档](https://flask-sqlalchemy.palletsprojects.com/){: rel="nofollow"}
4. [Flask-Caching 文档](https://flask-caching.readthedocs.io/){: rel="nofollow"}