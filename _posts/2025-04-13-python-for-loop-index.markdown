...
## 参考资料
- [Python 官方文档 - range()](https://docs.python.org/3/library/functions.html#range){: rel="nofollow"}
- [Python 官方文档 - enumerate()](https://docs.python.org/3/library/functions.html#enumerate){: rel="nofollow"}
- [Python 官方文档 - zip()](https://docs.python.org/3/library/functions.html#zip){: rel="nofollow"}