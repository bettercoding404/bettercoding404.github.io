...
## 参考资料
- [Python 官方文档 - String Formatting](https://docs.python.org/3/library/string.html#formatstrings){: rel="nofollow"}
- [Python Format String Cookbook](https://mkaz.blog/code/python-string-format-cookbook/){: rel="nofollow"}