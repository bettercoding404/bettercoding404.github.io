...
- [深入理解Python GIL](https://www.dabeaz.com/python/UnderstandingGIL.pdf){: rel="nofollow"}
- [Python多线程与多进程的性能对比](https://www.geeksforgeeks.org/multithreading-vs-multiprocessing-in-python/){: rel="nofollow"}