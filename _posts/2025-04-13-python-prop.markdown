...
## 参考资料
- [Python 官方文档 - Properties](https://docs.python.org/3/howto/descriptor.html#properties){: rel="nofollow"}
- [Python 教程 - Properties](https://www.tutorialspoint.com/python3/python3_properties.htm){: rel="nofollow"}
- [Effective Python - Item 26: Use properties for lazy attributes](https://effectivepython.com/2015/04/14/item-26-use-properties-for-lazy-attributes/){: rel="nofollow"}