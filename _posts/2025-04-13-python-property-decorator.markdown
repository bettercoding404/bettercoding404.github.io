...
- [Python教程 - Property装饰器](https://www.runoob.com/python3/python3-property.html){: rel="nofollow"}
- [Effective Python - 条款26：使用@property来代替需要复杂处理的属性](https://book.douban.com/subject/25779934/){: rel="nofollow"}