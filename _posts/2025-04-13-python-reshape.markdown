...
## 参考资料
- [NumPy官方文档 - reshape函数](https://numpy.org/doc/stable/reference/generated/numpy.reshape.html){: rel="nofollow"}
- [Python数据分析实战（第2版）](https://book.douban.com/subject/25749090/){: rel="nofollow"}
- [TensorFlow官方文档 - 数据处理](https://www.tensorflow.org/guide/data){: rel="nofollow"}