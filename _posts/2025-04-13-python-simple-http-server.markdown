...
- [Python官方文档 - BaseHTTPServer](https://docs.python.org/2/library/basehttpserver.html){: rel="nofollow"}
- [Python官方文档 - SocketServer](https://docs.python.org/3/library/socketserver.html){: rel="nofollow"}