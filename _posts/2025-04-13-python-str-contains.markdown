...
## 参考资料
- [Python 官方文档 - 字符串类型](https://docs.python.org/3/library/stdtypes.html#text-sequence-type-str){: rel="nofollow"}
- 《Python 核心编程》
- [Stack Overflow - Python 判断字符串是否包含子字符串](https://stackoverflow.com/questions/3437059/does-python-have-a-string-contains-substring-method){: rel="nofollow"}