...
- [tabulate库文档](https://pypi.org/project/tabulate/){: rel="nofollow"}
- [pandas库文档](https://pandas.pydata.org/docs/){: rel="nofollow"}
- [matplotlib库文档](https://matplotlib.org/){: rel="nofollow"}
- [seaborn库文档](https://seaborn.pydata.org/){: rel="nofollow"}