...
## 参考资料
- [python-dotenv 官方文档](https://github.com/theskumar/python-dotenv){: rel="nofollow"}
- [Python 官方文档 - 环境变量处理](https://docs.python.org/3/library/os.html#os.environ){: rel="nofollow"}