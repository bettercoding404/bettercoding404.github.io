...
- [Python 官方文档 - 格式化字符串](https://docs.python.org/3/library/string.html#formatstrings){: rel="nofollow"}
- [numpy 官方文档 - `np.around()`](https://numpy.org/doc/stable/reference/generated/numpy.around.html){: rel="nofollow"}