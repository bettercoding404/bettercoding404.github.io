...
## 参考资料
- [Python 官方文档 - 字符串对象](https://docs.python.org/3/library/stdtypes.html#string-methods){: rel="nofollow"}
- [Python 官方文档 - string 模块](https://docs.python.org/3/library/string.html){: rel="nofollow"}