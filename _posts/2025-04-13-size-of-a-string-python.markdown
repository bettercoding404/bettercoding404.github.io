...
- [Python 官方文档 - sys.getsizeof() 函数](https://docs.python.org/3/library/sys.html#sys.getsizeof){: rel="nofollow"}
- [Python 官方文档 - str.encode() 方法](https://docs.python.org/3/library/stdtypes.html#str.encode){: rel="nofollow"}