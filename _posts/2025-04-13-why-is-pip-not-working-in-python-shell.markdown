...
## 参考资料
1. [Python官方文档 - pip](https://pip.pypa.io/en/stable/){: rel="nofollow"}
2. [Python虚拟环境官方文档](https://docs.python.org/3/library/venv.html){: rel="nofollow"}
3. [PyPI官方网站](https://pypi.org/){: rel="nofollow"}